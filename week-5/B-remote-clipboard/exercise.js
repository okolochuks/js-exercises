...
var clipboardTitle = "Ecosystem";
var clipboardText = "Define Ecosystem";
...
// Add your code below
var messageBox = document.getElementById("greeting-text");
fetch("https://codeyourfuture.herokuapp.com/api/clipboard?title=Ecosystem")
  .then(function(response) {
    return response.text();
  })
  .then(function(logo) {
    messageBox.innerHTML = logo;
  });
